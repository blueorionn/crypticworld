    ...
    <>
      <footer className='relative z-[100] w-full border-t-2 border-gray-300 bg-gray-200 py-4 lg:py-6 dark:border-gray-700 dark:bg-gray-900'>
        <div className='mx-auto flex max-w-5xl flex-col items-center justify-between px-4 md:flex-row'>
          ...
          <a
            className='flex items-center justify-center gap-1 text-gray-700 md:gap-2 dark:text-gray-300'
            href='https://github.com/blueorionn/crypticworld'
          >
            <span>Made by swadhin</span>
            <svg
              className='h-4 w-4 fill-black lg:h-6 lg:w-6 dark:fill-white'
