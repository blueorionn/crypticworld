...
export default function SideBar({ hashUrl }: { hashUrl: string }) {
  return (
    <>
      <aside className='fixed top-0 z-[100] min-h-[100vh] w-full max-w-[15rem] flex-col gap-4 bg-gray-300 px-8 py-6 shadow-md shadow-gray-400 brightness-105 transition-all duration-300 lg:max-w-xs lg:px-10 xl:relative xl:z-50 xl:flex dark:bg-slate-700 dark:shadow-none dark:brightness-90'>
